...
import { faFileInvoiceDollar, faQuestionCircle } from '@fortawesome/free-solid-svg-icons'
import { faGitAlt, faGithub, faBootstrap, faReact } from '@fortawesome/free-brands-svg-icons'

const getSVG = (name: string, width: string) => {
    switch (name) {
        case 'CSharp':
            return (
                <svg fill="none" viewBox="204.925 153.577 757.617 860.543" width={width} xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="m584.667 582.333-371.34 213.794c6.069 10.97 15.405 20.306 27.775 27.542 59.984 34.776 260.941 149.842 301.086 173.649 27.074 15.872 53.449 16.572 80.523.7 100.829-58.35 201.891-116.233 302.72-174.349 12.603-7.236 21.706-16.338 27.774-27.542z" fill="#6a1577" />
                    ...
                    <path d="m962.542 407.983c0-14.237-3.035-27.074-9.336-37.811l-368.539 212.161 369.005 213.795c5.835-10.737 8.87-23.107 8.87-37.111z" fill="#813084" />
                    <g fill="#fff">
        ...
        case 'Typescript':
            return (
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 400" width={width} >
        ...
        case 'Node.js':
            return (
                <svg width={width} viewBox="0 0 256 282" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet">
                    <g fill="#8CC84B">
        ...
        case 'Python':
            return (
                <svg width={width} viewBox="0 0 256 255" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet">
                    <defs>
        ...
        case 'React':
            return (
                <FontAwesomeIcon icon={faReact} color="#61DAFB" style={{ fontSize: width }} />
            );
        case 'Bash':
            return (
                <FontAwesomeIcon icon={faFileInvoiceDollar} color="limegreen" style={{ fontSize: width }} />
            );
        case 'Coming Soon':
            return (
                <FontAwesomeIcon icon={faQuestionCircle} color="red" style={{ fontSize: width }} />
            );
        case 'Material Design':
            return (
                <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width={width} >
        ...
        case 'Bootstrap':
            return (
                <FontAwesomeIcon icon={faBootstrap} color="#563d7c" style={{ fontSize: width }} />
            );
        case 'Github':
            return (
                <FontAwesomeIcon icon={faGithub} style={{ fontSize: width }} />
            );
        case 'Git':
            return (
                <FontAwesomeIcon icon={faGitAlt} color="#f14e32" style={{ fontSize: width }} />
            );
    }
}

const Icon: React.FC<{ name: string, className: string, width: string }> = ({ name, className, width }) => <div className={className} style={{ width: width }}>{getSVG(name, width)}</div>
